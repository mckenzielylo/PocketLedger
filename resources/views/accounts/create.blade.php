            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Create a new bank account, cash, e-wallet, or credit card</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                    ...
                    <label class="relative flex cursor-pointer rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 p-4 shadow-sm focus:outline-none account-type-option" data-type="credit-card">
                        <input type="radio" name="type" value="credit-card" class="sr-only" {{ old('type') === 'credit-card' ? 'checked' : '' }}>
                        <div class="flex flex-1">
                            <div class="flex flex-col">
