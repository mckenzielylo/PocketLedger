...
<x-page-layout 
    ...
    :actions="'<div class=\"flex items-center space-x-3\">' . 
        '<a href=\"' . route('transactions.create') . '\" class=\"inline-flex items-center px-4 py-2 bg-primary text-primary-foreground hover:bg-primary/90 rounded-md text-sm font-medium\"><svg class=\"-ml-1 mr-2 h-5 w-5\" fill=\"none\" stroke=\"currentColor\" viewBox=\"0 0 24 24\"><path stroke-linecap=\"round\" stroke-linejoin=\"round\" stroke-width=\"2\" d=\"M12 6v6m0 0v6m0-6h6m-6 0H6\"></path></svg>Add Transaction</a>' .
        '</div>'"
>
                    <!-- Search -->
    ...
    @else
        <!-- Empty State -->
        <x-ui.card>
            <x-ui.card-content class="text-center py-20">
                <div class="mx-auto w-24 h-24 bg-gradient-to-br from-muted to-muted/50 rounded-3xl flex items-center justify-center mb-6">
                ...
                <p class="text-muted-foreground mb-8 max-w-sm mx-auto">Start tracking your finances by adding your first transaction.</p>
                <x-ui.button tag="a" href="{{ route('transactions.create') }}">
...
<div class="fixed bottom-20 right-4 z-50">
    <x-ui.button 
        ...
        size="icon"
        class="w-16 h-16 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-110"
    >
