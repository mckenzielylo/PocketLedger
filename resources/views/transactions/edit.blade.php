...
<div class="min-h-screen bg-gray-50 dark:bg-gray-900">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Update transaction details</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="px-4 py-6 sm:px-6">
        <form action="{{ route('transactions.update', $transaction) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div id="transfer-section" class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 {{ $transaction->type === 'transfer' ? '' : 'hidden' }}">
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <input type="date" 
                       name="occurred_on" 
                       id="occurred_on" 
                       value="{{ old('occurred_on', $transaction->occurred_on->format('Y-m-d')) }}"
                       class="block w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary-500 focus:border-transparent">
                @error('occurred_on')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                ...
                <textarea name="note" 
                          ...
                          rows="3"
                          class="block w-full px-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                          placeholder="Add any additional details...">{{ old('note', $transaction->note) }}</textarea>
                @error('note')
                    <p class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                @enderror
            </div>
                ...
                @if($transaction->receipt_path)
                    <div class="mb-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                        <div class="flex items-center space-x-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">Current Receipt</p>
                                <p class="text-sm text-gray-500 dark:text-gray-400">Upload a new file to replace</p>
                            </div>
                        </div>
                    </div>
                @endif
